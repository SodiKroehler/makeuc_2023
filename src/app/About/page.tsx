...
const About = () => {
    ...
    <div className='BodyParagraph'>
        ...
        <p>Meet the trio behind NotesAnywhere: Kevin Pak, Sodi Kroehler, and Isaiah LaDuke. We're on a mission to revolutionize the way you create and manage your notes.
            ...
            Have you ever struggled to locate important notes buried deep within the pages of your notebooks? Or found it challenging to keep up with a fast-paced lecture? Perhaps you've experienced the frustration of trying to obtain class notes when you couldn't attend due to illness. Maybe you have a disability and have struggled to keep up with pace of the class. We understand the common pain points of note-taking, and that's why we created NotesAnywhere.
